...
export default async function ChairDetailPage({
  ...
  return (
    <main className="w-full min-h-screen py-16">
      ...
      <div className="bg-red-500 p-4 absolute top-0 left-0 w-24 h-full flex justify-center hidden lg:block">
        <h1 className="text-white text-[36px] font-bold [writing-mode:vertical-rl]">
          {chair.name_jp}
        </h1> 
      </div>
    </main>
